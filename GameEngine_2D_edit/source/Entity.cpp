...
bool Entity::LoadVertShader(const char* filePath)
{
...
bool Entity::LoadFragShader(const char* filePath)
{
	std::string vs =textFileReader(filePath);
...
void Entity::LoadTexture(const char* a_pTexture)
{
...
void Entity::SetColor(Vector4 a_v4Color)
{
...
void Entity::SetColor(Vector4 a_v4Color0,Vector4 a_v4Color1,Vector4 a_v4Color2,Vector4 a_v4Color3)
{
